...
class SimpleDataProc(GeoEDFPlugin):
 ...
 # commenting as a part to create the processor   
        ...
        #         raise GeoEDFError('start_year must be smaller than end_year in SimpleDataProc')
        # except:
        #     raise GeoEDFError('Error occurred when validating start_year and end_year for SimpleDataProc; make sure they are integers')
